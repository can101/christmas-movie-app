...
const Banner: FC = (): ReactElement => {
    ...
    return (
        <div className='banner-container'>
            <span>Yılbaşına son <span className={"banner-text-highlight"}> {differenceDays} gün {differenceHours} saat {differenceMinutes} dakika {differenceSeconds} saniye kaldı</span></span>
        </div>
    )
}
